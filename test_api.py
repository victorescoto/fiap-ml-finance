...
def main():
    ...
    # 3. Dados históricos
    test_endpoint("Dados Históricos AAPL",
                  f"{API_BASE}/historical/AAPL?period=1mo")
    ...
    test_endpoint("Treinar Modelo AAPL",
                  f"{API_BASE}/train", "POST", train_data)
    ...
    test_endpoint("Status dos Modelos (Após Treinamento)",
                  f"{API_BASE}/models")
    ...
    test_endpoint("Predição AAPL (5 dias)",
                  f"{API_BASE}/predict", "POST", predict_data)
    ...
    test_endpoint("Predição AAPL (com confiança)",
                  f"{API_BASE}/predict", "POST", predict_data_confidence)
